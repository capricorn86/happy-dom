...
export const observeMutationsOnce = Symbol('observeMutationsOnce');
...
export const attachedHTMLCollection = Symbol('attachedHTMLCollection');
...
export const isInsideObservedFormNode = Symbol('isInsideObservedFormNode');

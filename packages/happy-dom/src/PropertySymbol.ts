...
export const getWindow = Symbol('getWindow');
export const onNodeListChange = Symbol('onNodeListChange');
...
export const submitWithBrowserFrame = Symbol('submitWithBrowserFrame');
export const getDisplaySize = Symbol('getDisplaySize');

...
export const formAssociated = Symbol('formAssociated');
export const internalsFormValue = Symbol('internalsFormValue');
export const elementInternals = Symbol('elementInternals');
...
export const onCustomElementConnected = Symbol('onCustomElementConnected');
export const addIdentifierToWindow = Symbol('addIdentifierToWindow');

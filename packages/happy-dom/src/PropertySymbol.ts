...
export const attributeFilter = Symbol('attributeFilter');
export const onObservedItemAttributeChange = Symbol('onObservedItemAttributeChange');
export const observeDocument = Symbol('observeDocument');
export const unobserveDocument = Symbol('unobserveDocument');
export const htmlCollection = Symbol('htmlCollection');

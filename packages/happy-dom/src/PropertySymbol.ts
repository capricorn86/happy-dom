...
export const setNamedItemNS = Symbol('setNamedItemNS');
...
export const removeNamedItemNS = Symbol('removeNamedItemNS');
...
export const createNamedItemsNodeList = Symbol('createNamedItemsNodeList');
export const updateNamedItemProperty = Symbol('updateNamedItemProperty');
...
export const replaceItems = Symbol('replaceItems');
export const clearItems = Symbol('clearItems');
export const addItems = Symbol('addItems');
export const querySelectorCache = Symbol('querySelectorCache');
export const querySelectorAllCache = Symbol('querySelectorAllCache');
export const matchesCache = Symbol('matchesCache');
export const styleCache = Symbol('styleCache');
export const computedStyleCache = Symbol('computedStyleCache');
export const computedStyleCacheReferences = Symbol('computedStyleCacheReferences');
export const clearComputedStyleCache = Symbol('clearComputedStyleCache');
export const clearCache = Symbol('clearCache');
export const insertObservedItem = Symbol('insertObservedItem');
export const removeObservedItem = Symbol('removeObservedItem');
export const observe = Symbol('observe');
export const unobserve = Symbol('unobserve');
export const loadObservedNodes = Symbol('loadObservedNodes');
export const unloadObservedNodes = Symbol('unloadObservedNodes');
export const onSetAttribute = Symbol('onSetAttribute');
export const onRemoveAttribute = Symbol('onRemoveAttribute');
export const observeDocument = Symbol('observeDocument');
export const unobserveDocument = Symbol('unobserveDocument');

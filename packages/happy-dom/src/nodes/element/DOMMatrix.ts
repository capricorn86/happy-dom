...
export default class DOMMatrix extends DOMMatrixReadOnly {
	 ...
	 * @returns Self.
	 */
	public multiplySelf(secondMatrix: DOMMatrixReadOnly | IJSONMatrix): DOMMatrix {

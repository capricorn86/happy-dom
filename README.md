...
| ------- | ---------- | ---------------- |
| 0.6.0   | 2019-10-28 | Thanks to [@mat3e](https://github.com/mat3e) we now have support for hasAttributes(). The "attributes" has aldo been changed. It is now returning an object instead of array. (#13).
